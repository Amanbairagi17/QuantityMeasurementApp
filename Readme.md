...
## Overview  
Refactored arithmetic methods (`add`, `subtract`, `divide`) to remove duplicated logic and enforce the **DRY principle**.

## What Was Added  
- `ArithmeticOperation` enum (ADD, SUBTRACT, DIVIDE)  
- `performBaseArithmetic()` helper method  
- `validateArithmeticOperands()` centralized validation  

## What Improved  
- Removed repeated validation code  
- Removed repeated base-unit conversion logic  
- Cleaner and shorter arithmetic methods  
- Easier to extend (e.g., MULTIPLY)

## Principles Followed  
- DRY (Don’t Repeat Yourself)  
- SRP (Single Responsibility Principle)  
- Encapsulation  
- Backward Compatibility (All UC12 tests passed)

## Result  
Same behavior as UC12.  
Better structure.  
...
UC14 extends the Quantity Measurement application by adding support for **Temperature** measurements.

Temperature is added alongside existing categories:
...
All UC1–UC13 features remain fully operational.
...
- Support for:
  ...
  - FAHRENHEIT
  - KELVIN
- Non-linear temperature conversion formulas
- Temperature equality comparison across units

---

## Design Approach

- Base unit chosen: **Celsius**
- Conversion uses:
